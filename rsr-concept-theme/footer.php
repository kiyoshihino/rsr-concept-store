        ...
        <div class="Footer_grid">
            <div class="Footer_brand">
                <a href="<?php echo home_url('/'); ?>" class="Footer_logo">
                    <span class="Footer_logoText">RSR</span>
                    <span class="Footer_logoSubtext">Concept Store</span>
                </a>
            ...
            <div class="Footer_links">
                ...
                <nav class="Footer_nav">
                    ...
                    ?>
                    <a href="<?php echo esc_url( add_query_arg('filter_cat', 'vestuario', $shop_url) ); ?>">Vestuário</a>
                    <a href="<?php echo esc_url( add_query_arg('filter_cat', 'acessorios', $shop_url) ); ?>">Acessórios</a>
                    <a href="<?php echo esc_url( add_query_arg('filter_cat', 'decoracao', $shop_url) ); ?>">Decoração</a>
                    <a href="<?php echo esc_url( add_query_arg('filter_cat', 'kits', $shop_url) ); ?>">Kits</a>
                </nav>
            </div>
            ...
            <div class="Footer_contact">
                ...
                <div class="Footer_nav">
                    <a href="mailto:hello@rsrconcept.com">hello@rsrconcept.com</a>
                    <a href="tel:+5511999999999">(11) 99999-9999</a>
                    <span style="opacity: 0.85; font-size: var(--text-base);">São Paulo, SP</span>
                </div>
            </div>
        </div>
